  ...
  static function getChats(): array {
    return [
      513209606 => [
        "charm" => [
          "Charm | Baby's AK" => [
            ['pattern_m' => 79_500, 'pattern_l' => 100_000, 'price_percent' => 20],
...
//          ],
        ...
        "skin" => [
          "SSG 08 | Acid Fade (Factory New)" => [
            ['price_percent' => 20, 'paintseed' => [576,575,449,897,468,961,550,107,807,80,648,278,849,236,690,345,182,522,230,761,803,178,206,773]],
          ],
        ]
      ]
    ];
